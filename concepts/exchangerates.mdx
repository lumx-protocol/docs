...
Data points included in an exchange rate response:- **Lumx ID:** Unique identifier for the exchange rate within Lumx.
...
Next, let's learn more about our [On/Off ramp processes](/essentials/onofframp).