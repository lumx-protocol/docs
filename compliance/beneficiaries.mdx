...
For compliance purposes, every beneficiary is also considered the originator of the funds. This means that when creating a beneficiary and initiating a payment, the beneficiary will be regarded as the source of the funds.
