---
title: "Open API download"
description: "Download our Open API documentation and import it anywhere"
---
<CodeGroup>
...
```json JSON
{
  ...
  "paths": {
    ...
    "/wallets": {
                ...
                "schema": {
                  "allOf": [
                    ...
                    },
                    {
                      ...
                      "properties": {
                        "blockchains": {
                          "$ref": "#/components/schemas/WalletBlockchains",
                          "example": [
                            {
                              "name": "Polygon",
                              "address": "0x09f6b4f487ee3e78194ba886af0035f6af0035f6",
                              "blockExplorerUrl": "https://polygonscan.com/address/0x09f6b4f487ee3e78194ba886af0035f6af0035f6",
                              "deployedAt": null
                            },
                            {
                              "name": "Ethereum",
                              "address": "0x871a2644bdc0c843283351f026d9d19826d9d198",
                              "blockExplorerUrl": "https://etherscan.io/address/0x871a2644bdc0c843283351f026d9d19826d9d198",
                              "deployedAt": null
                            }
                          ]
                        }
      ...
      "get": {
        ...
        "description": "This endpoint reads all wallets",
        "parameters": [
          {
            "in": "query",
            "name": "cursor",
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "description": "Optional. A case-insensitive, comma-separated list of the blockchains from which to retrieve the wallet's tokens. By default, it will return tokens from all our supported [blockchains.](https://docs.lumx.io/get-started/blockchains)"
          }
        ],
        "responses": {
          "200": {
            "description": "The details of the wallet and the list of tokens it holds were retrieved successfully.",
            "content": {
              "application/json": {
                "schema": {
                  "allOf": [
                      ...
                      "properties": {
                        "blockchains": {
                          ...
                          "items": {
                            "allOf": [
                              {
                                "$ref": "#/components/schemas/WalletBlockchain"
                              },
                              {
                                "$ref": "#/components/schemas/TokensArray"
                              }
                            ]
                          }
                        }
    ...
    "/contracts": {
      "post": {
        ...
        "description": "This endpoint creates a contract. Please, remember to deploy the contract before interacting with it.",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
        ...
        "parameters": [
          ...
          },
          {
            ...
            "schema": {
              ...
              "example": "Polygon",
              "description": "The contract's blockchain (case insensitive)"
            },
            "required": false
          }
        ],
    ...
    "/contracts/{contractId}/token-types": {
      "post": {
        ...
        "description": "This endpoint creates a token type for a contract.",
        "parameters": [
          {
            "name": "contractId",
            "in": "path",
    ...
    "/transactions/mints": {
      "post": {
        ...
        "summary": "Mint tokens",
        "description": "Mint one or multiple tokens and send them to a wallet. Important: This is an ASYNC route! Use the read transaction route to check the mint's status.",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
        ...
        "responses": {
          "202": {
            "description": "The mint request was submitted to the blockchain. Important: This is an ASYNC route! Use the read transaction route to check the mint's status.",
            "content": {
              "application/json": {
                "schema": {
                  "allOf": [
    ...
    "/transactions/transfers": {
      "post": {
        ...
        "description": "Transfer tokens from a wallet. Important: This is an ASYNC route! Use the read transaction route to check the transfer's status.",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                    ...
                    "allOf": [
                      ...
                      },
                      {
                        ...
                        "properties": {
                          "tokenId": {
                            "type": "string",
                            "description": "The ID of the token that will be transferred. Not applicable for fungible tokens."
                          }
                        },
                        "required": [
                          "tokenId"
                    ...
                    "allOf": [
                      ...
                      },
                      {
                        ...
                        "properties": {
                          "quantity": {
                            "type": "number",
                            "description": "The quantity of tokens to transfer. Not applicable for non-fungible tokens."
                          }
                        },
                        "required": [
                          "quantity"
        ...
        "responses": {
          "202": {
            "description": "The transfer operation was submitted to the blockchain. Important: This is an ASYNC route! Use the read transaction route to check the transfer's status.",
            "content": {
              "application/json": {
                "schema": {
                  "allOf": [
    ...
    "/transactions/custom": {
      "post": {
        ...
        "responses": {
          "202": {
            "description": "The transaction was submitted to the blockchain. Important: This is an ASYNC route! Use the read transaction route to check its status.",
            "content": {
              "application/json": {
                "schema": {
                  "allOf": [
  ...
  "components": {
    "schemas": {
      ...
      "WalletBlockchain": {
        ...
        "properties": {
          ...
          "deployedAt": {
            "type": "string",
            "format": "date-time",
            "description": "The timestamp from when the wallet was deployed on this network.",
            "nullable": true
          }
        }
      },
      "WalletBlockchains": {
        "type": "array",
        "description": "The list of blockchains to which this wallet belongs and their corresponding addresses.",
        "items": {
          "$ref": "#/components/schemas/WalletBlockchain"
        }
      },
      ...
      "TokenResponse": {
        ...
        "properties": {
          ...
          "rawBalance": {
            "type": "string",
            "description": "The unformatted balance of the token, representing the quantity of the token present at this wallet."
          },
          "floatBalance": {
            "type": "string",
            "description": "The formatted balance of the token, representing the quantity of the token present at this wallet with proper formatting for display purposes."
          }
        }
      },
      "ContractRequest": {
        ...
        "properties": {
          ...
          "blockchain": {
            "$ref": "#/components/schemas/Blockchains",
            "description": "The network where the contract will be created.",
            "example": "Polygon",
            "default": "Polygon"
          }
        }
      ...
      "ContractResponse": {
        ...
        "properties": {
          ...
          "baseUri": {
            ...
            "nullable": true,
            "format": "url",
            "description": "The base URI where this contract's tokens' metadata files are located."
          },
          "blockExplorerUrl": {
            "type": "string",
            "nullable": true,
      ...
      "TokenTypeUpdateRequest": {
        ...
        "properties": {
          ...
          "maxSupply": {
            "type": "number",
            "description": "The max supply of the token type.",
            "maximum": 2000000000
          },
          "traits": {
            "type": "object",
            "description": "The traits of the token type. The key is the name of the trait and the value is the value of the trait."
          },
          "imageUrl": {
            "type": "string",
            "description": "The image URL of the token type. Supported formats are PNG, JPEG, GIF or MP4."
          }
        }
      },
      ...
      "ReadContractFunctionRequest": {
        ...
        "properties": {
          ...
          "blockchain": {
            "$ref": "#/components/schemas/Blockchains",
            "example": "Polygon",
            "description": "The contract's blockchain."
          },
          "functionSignature": {
            "type": "string",
      ...
      "SignMessageResponse": {
        ...
        "properties": {
          "signedMessage": {
            "type": "string",
            "description": "The signature of the message in hexadecimal format."
          }
        }
      }
    },
