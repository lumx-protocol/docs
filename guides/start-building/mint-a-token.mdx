...
Firstly, we need to mint the token. This route is used to mint both fungible and non-fungible tokens.
However, for fungible tokens, the uriNumber should always be 0, regardless of the value sent.
