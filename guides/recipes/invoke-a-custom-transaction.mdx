...
<Info>
  This example transaction is for a contract that was deployed on Polygon Amoy
  testnet.
</Info>
...
```bash cURL
    curl --request POST \
    --url https://protocol-sandbox.lumx.io/v2/advanced/custom \
...
axios
  .post("https://protocol-sandbox.lumx.io/v2/advanced/custom", {
    contractAddress: "0xa7Cb3EF2e19bCAA7C765370c39d7a06ea5595D08",
    walletId: "<WALLET_ID>",
    operations: [
      {
