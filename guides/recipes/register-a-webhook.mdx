...
You will receive a status 200 with an object containing the details of the created webhook.

<Info>The available event types are mint, transfer, and custom.</Info>
```json
[
  {
    "id": 1,
