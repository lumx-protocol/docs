...
To create a webhook, head to the [dashboard](https://dashboard.lumx.io/), click on the **Settings** tab, and then head to the **Webhooks** tab. There you can register your webhook and set the events you want to receive.
