...
To create a developer fee, you need to go to the [dashboard](https://dashboard.lumx.io/login/?to=%2Fsettings%2Fdeveloper-fees), select the project and create your fee.
